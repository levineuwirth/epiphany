...
(\texttt{start}/\texttt{end}, jump targets, volta spans). The rule row is
the core specification's (Chapter~6 re-anchoring rule table, ratified with
this pair).

\textbf{Authoring advisory.} The volta well-formedness constraints of
core Chapter~5 (endings non-empty, 1-based, ascending) are
