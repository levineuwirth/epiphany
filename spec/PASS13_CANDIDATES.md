...
## Open candidates (Batch 3 not yet open)

Filed as found; the pass reopens at three (the house rule). Neither is a live
incorrectness — each is a place where the spec cannot yet support a claim it
makes about itself.
